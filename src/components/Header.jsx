  ...
  return (
    <>
      ...
      <header className="bg-white fixed w-full top-0 left-0 z-[60] shadow-sm">
        <div className="container mx-auto my-4 px-4 max-w-[1440px]">
          ...
          <div className="flex items-center justify-between h-[60px]">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="lg:hidden">
                <button
                  className={`transition-colors duration-300 ${isSearchOpen ? "text-pink-600" : "text-gray-400"
                    }`}
        ...
        {/* Menu mobile */}
        <div
          className={`fixed top-[60px] left-0 h-[calc(100vh-60px)] w-[280px] bg-white z-50 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? "translate-x-0" : "-translate-x-full"
            } lg:hidden`}
        >
